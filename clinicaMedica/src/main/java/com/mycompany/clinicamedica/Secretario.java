...
public class Secretario extends Pessoa{
    ...
    public boolean setSalario(double salario) {
     ...
     public ArrayList<ConsultaPlano> getConsultaPlano() {
        return consultaPlano;
    }
     

    public void setConsultaPlano(ArrayList<ConsultaPlano> consultaPlano) {
        this.consultaPlano = consultaPlano;
    }
    

    public ArrayList<ConsultaParticular> getConsultaParticular() {
        return consultaParticular;
    }
    

    public void setConsultaParticular(ArrayList<ConsultaParticular> consultaParticular) {
